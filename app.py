...
text_data = {
    "한국어": {
        ...
        "col_venue": "공연장", "col_region": "지역", "col_price": "티켓가격(원)", "col_rate": "예매율(%)"
    },
    "English": {
        ...
        "table_title": "📊 Filtered Performance Details",
        ...
        "col_venue": "Venue", "col_region": "Region", "col_price": "Price(KRW)", "col_rate": "Booking Rate(%)"
    }
}

# 현재 선택된 언어의 텍스트 세트 가져오기
t = text_data[lang]
...
df_display = df.rename(columns={
    ...
    "공연장": t["col_venue"], "지역": t["col_region"], "티켓가격(원)": t["col_price"], "예매율(%)": t["col_rate"]
})
